...
function Design() {
  return (
    <div className='design-container'>
      ...
      <p><a href='https://amalijewelry.com'>Amáli Jewelry</a> is luxury handcrafted jewelry company with a focus on handwoven chains and signature techniques.</p>
      ...
      <a href='https://amalijewelry.com'><img className='website-image' alt='A screenshot of the homepage of Amáli Jewelry' src='./images/Amali.png'></img></a>
